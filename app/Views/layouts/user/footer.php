    ...
    <div class="wrapper">
        <div class="left">
            <a onclick="closeMenu()" href="#home" class="logo">
                <img src="<?= asset('assets/images/logo2.png') ?>" alt="logotipo" width="80">
            </a>
            <p> &copy; clínica Agosmil 2026
            <P>Filomena Sudila Bonga Bazola</p>
            <p>Laurinda Bernarda da Silva Júlio</p>
        </div>
        <div class="right">
            <ul class="social-links">
                <li>
                    <a target="_blank" href="https://Instagram.com/"><svg
                            width="24"
                            height="24"
                            viewBox="0 0 24 24"
                            fill="none"
