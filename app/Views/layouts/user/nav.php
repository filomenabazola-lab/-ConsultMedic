<!-- top default.blade.php -->

<nav id="nav" class="">
      <div class="wrapper">
        <a onclick="closeMenu()" href="#home" class="logo">
          <img src="<?= asset('assets/images/logo2.png') ?>" alt="" width="60" >
        </a>
 
        <div class="menu">
          <ul id="main">
            <li ><a class="home" href="<?=URL?>\#home" onclick="closeMenu()">Inicio</a></li>
            <li ><a class="services" onclick="closeMenu()" href="<?=URL?>\#services">Serviços</a></li>

            <!-- <li ><a class="Departments" onclick="closeMenu()" href="<?=URL?>\#about">Departamentos</a></li> -->

            <li ><a class="about" onclick="closeMenu()" href="<?=URL?>\#about">Sobre</a></li>

          </ul>

          <a onclick="closeMenu()" href="<?=URL?>\#contacts" class="button">Agende Agora</a>
