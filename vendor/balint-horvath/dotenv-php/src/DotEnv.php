...
use BalintHorvath\DotEnv\Exception\InvalidPathException;
...
class DotEnv extends \ArrayObject
{
    ...
    public function __construct($path = "../../../", bool $setEnvironmentVariables = true, bool $processSections = true, int $scannerMode = INI_SCANNER_TYPED)
    {
        $this->setPath($path);
